...
@RouterService(interfaces = ITestApp.class,key= ConstantsService.KEY_TestAppImpl1)
public class TestAppImpl1 implements ITestApp{
    @Override
    public void showInfo(Context context) {
        Toast.makeText(context, "Msg From app TestAppImpl1", Toast.LENGTH_SHORT).show();
    }
}
