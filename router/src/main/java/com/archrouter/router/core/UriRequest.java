...
public class UriRequest {
    ...
    public static final String FIELD_COMPLETE_LISTENER =
            "com.archrouter.router.core.CompleteListener";
    /**
     * 跳转请求的结果
     */
    public static final String FIELD_RESULT_CODE = "com.archrouter.router.core.result";
    /**
     * 跳转请求失败信息
     */
    public static final String FIELD_ERROR_MSG = "com.archrouter.router.core.error.msg";
